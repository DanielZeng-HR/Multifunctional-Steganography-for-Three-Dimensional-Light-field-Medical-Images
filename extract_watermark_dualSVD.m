function [txt_out, Extracted_logo] = extract_watermark_dualSVD(IMG, rows_LSB_interval_3, cols_LSB_interval_3, ...
    rows_LSB_interval_4, cols_LSB_interval_4,rows_Max, cols_Max, ...
    end_number_LSB_3, end_number_LSB_4, end_number_Max, txtb, min_P_index, P, move, len,...
    rows_RONI, cols_RONI, RONI_length, root_num, U1, V1,S,af, setLength_logo, Embedded_RONI, max_val, min_val)
